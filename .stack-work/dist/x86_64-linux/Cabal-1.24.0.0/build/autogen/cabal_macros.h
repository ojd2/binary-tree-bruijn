...
/* package tree-base-lambda-0.1.0.0 */
#define VERSION_tree_base_lambda "0.1.0.0"
#define MIN_VERSION_tree_base_lambda(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "tree-base-lambda-0.1.0.0-GF8TrCPpOSdDJMLU4eGQjv"

#define CURRENT_PACKAGE_KEY "tree-base-lambda-0.1.0.0-GF8TrCPpOSdDJMLU4eGQjv"
